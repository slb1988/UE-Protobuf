...
class Duration :
 ...
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&::descriptor_table_duration_2eproto);
    return ::descriptor_table_duration_2eproto.file_level_metadata[kIndexInFileMessages];
  }
