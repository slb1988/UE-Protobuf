...
static void InitDefaultsscc_info_SourceContext_source_5fcontext_2eproto() {
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_SourceContext_source_5fcontext_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, InitDefaultsscc_info_SourceContext_source_5fcontext_2eproto}, {}};

static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_source_5fcontext_2eproto[1];
static constexpr ::PROTOBUF_NAMESPACE_ID::EnumDescriptor const** file_level_enum_descriptors_source_5fcontext_2eproto = nullptr;
static constexpr ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor const** file_level_service_descriptors_source_5fcontext_2eproto = nullptr;

const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_source_5fcontext_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
...
static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::google::protobuf::_SourceContext_default_instance_),
};

const char descriptor_table_protodef_source_5fcontext_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  ;
static const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable*const descriptor_table_source_5fcontext_2eproto_deps[1] = {
};
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_source_5fcontext_2eproto_sccs[1] = {
  &scc_info_SourceContext_source_5fcontext_2eproto.base,
};
static ::PROTOBUF_NAMESPACE_ID::internal::once_flag descriptor_table_source_5fcontext_2eproto_once;
static bool descriptor_table_source_5fcontext_2eproto_initialized = false;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_source_5fcontext_2eproto = {
  &descriptor_table_source_5fcontext_2eproto_initialized, descriptor_table_protodef_source_5fcontext_2eproto, "source_context.proto", 235,
  &descriptor_table_source_5fcontext_2eproto_once, descriptor_table_source_5fcontext_2eproto_sccs, descriptor_table_source_5fcontext_2eproto_deps, 1, 0,
  schemas, file_default_instances, TableStruct_source_5fcontext_2eproto::offsets,
  file_level_metadata_source_5fcontext_2eproto, 1, file_level_enum_descriptors_source_5fcontext_2eproto, file_level_service_descriptors_source_5fcontext_2eproto,
};

// Force running AddDescriptors() at dynamic initialization time.
static bool dynamic_init_dummy_source_5fcontext_2eproto = (  ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_source_5fcontext_2eproto), true);
namespace google {
namespace protobuf {
...
void SourceContext::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_SourceContext_source_5fcontext_2eproto.base);
  file_name_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
