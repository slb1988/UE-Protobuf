...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_Timestamp_timestamp_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, InitDefaultsscc_info_Timestamp_timestamp_2eproto}, {}};

static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_timestamp_2eproto[1];
static constexpr ::PROTOBUF_NAMESPACE_ID::EnumDescriptor const** file_level_enum_descriptors_timestamp_2eproto = nullptr;
static constexpr ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor const** file_level_service_descriptors_timestamp_2eproto = nullptr;

const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_timestamp_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
...
static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::google::protobuf::_Timestamp_default_instance_),
};
...
const char descriptor_table_protodef_timestamp_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "wnTypesb\006proto3"
  ;
static const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable*const descriptor_table_timestamp_2eproto_deps[1] = {
};
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_timestamp_2eproto_sccs[1] = {
  &scc_info_Timestamp_timestamp_2eproto.base,
};
static ::PROTOBUF_NAMESPACE_ID::internal::once_flag descriptor_table_timestamp_2eproto_once;
static bool descriptor_table_timestamp_2eproto_initialized = false;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_timestamp_2eproto = {
  &descriptor_table_timestamp_2eproto_initialized, descriptor_table_protodef_timestamp_2eproto, "timestamp.proto", 215,
  &descriptor_table_timestamp_2eproto_once, descriptor_table_timestamp_2eproto_sccs, descriptor_table_timestamp_2eproto_deps, 1, 0,
  schemas, file_default_instances, TableStruct_timestamp_2eproto::offsets,
  file_level_metadata_timestamp_2eproto, 1, file_level_enum_descriptors_timestamp_2eproto, file_level_service_descriptors_timestamp_2eproto,
};

// Force running AddDescriptors() at dynamic initialization time.
static bool dynamic_init_dummy_timestamp_2eproto = (  ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_timestamp_2eproto), true);
namespace google {
namespace protobuf {
